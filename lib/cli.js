...
module.exports = {
        ...
        callback: function(options) {
            ...
            function authenticate(auth, method, callback) {
                const request_options = {
                    url: `${constants.AUTH_API_BASE_URL}/v1/authenticate/${method}/authorization`,
                    method: 'POST'
                };
        ...
        callback: function() {
            ...
            request(request_options, function(err, response) {
                ...
                async.each(response.body.organizations || [], function(organization, fn) {
                    let request_options = {
                        url: `${constants.CLOUD_API_BASE_URL}/v2/organizations/${organization.id}`,
                        method: 'GET',
                        json: true,
                        headers: _.pick(config.config.headers, 'authorization')
                    };
    ...
    'destroy-cluster': {
        ...
        callback: function(options) {
            ...
            providers.vagrant.get_clusters(function(err, clusters) {
                let request_options = {
                    url: `${constants.CLOUD_API_BASE_URL}/v2/organizations/${config.config.headers['x-containership-cloud-organization']}/clusters`,
                    method: 'GET',
                    json: true,
                    headers: _.pick(config.config.headers, 'authorization')
                };
    ...
    'use-cluster': {
        ...
        callback: function(options) {
            config.load();
            config.config['api-url'] = constants.CLOUD_API_BASE_URL;
        ...
        callback: function() {
            ...
            async.waterfall([
                ...
                function(packager, fn) {
                    ...
                    let options = {
                        url: `${constants.BUILD_API_BASE_URL}/v1/organizations/${config.config.headers['x-containership-cloud-organization']}/${image}/builds`,
                        method: 'POST',
                        headers: {
                ...
                if(err) {
                    ...
                    let options = {
                        url: `${constants.BUILD_API_BASE_URL}/v1/organizations/${config.config.headers['x-containership-cloud-organization']}/builds/${build_id}/logs`,
                        method: 'GET',
                        headers: {
                            authorization: config.config.headers.authorization
                        },
